...
for shim_src in "$SDK_ROOT"/shim/*.c; do
    ...
    if [ "$stale" = 1 ]; then
        ...
        case "$shim_src" in
            ...
            */fork-nt.c|*/close-nt.c|*/ntspawn.c|*/ntaccesscheck.c|*/commandv.c|*/console.c|*/fchdir-nt.c|*/ftruncate-nt.c|*/proc.c|*/mkntpath.c|*/mkntpathat.c|*/read.c|*/readlinkat-nt.c|*/realpath.c)
